...
function _ensurePeopleOpsState(){
  ...
  if(!S.peopleSubTab||!["dashboard","team","agents","leaders","cover","org","logbook","events"].includes(S.peopleSubTab))S.peopleSubTab="dashboard";
...
function loadPeopleOps(){
  ...
  try{
    ...
    if(view){
      ...
      if(v.peopleSubTab&&["dashboard","team","agents","leaders","cover","org","logbook","events"].includes(v.peopleSubTab))S.peopleSubTab=v.peopleSubTab;
