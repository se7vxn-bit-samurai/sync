...
function _sheetParserFeatures(data,sheetName){
  ...
  let maxDatesInRow=0,dayHeaderRows=0,firstColDays=0,firstColDates=0,alternatingRows=0;
  ...
  return{rows,cols,maxDatesInRow,dayHeaderRows,firstColDays,firstColDates,alternatingRows,orientation,plausibleNameRows,
...
function autoParse(data,sn){
  ...
  const allParsers=["parseWideHoriz","parseHoriz","parseVert","parseBlocks","parsePerson"];
