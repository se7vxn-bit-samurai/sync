...
function loadSettings(){
  ...
  try{
    ...
    if(raw){
      ...
      if(s.peopleSubTab&&["dashboard","team","agents","cover","org","logbook","events"].includes(s.peopleSubTab))S.peopleSubTab=s.peopleSubTab;
