...
function _renderCardsZipPicker(){
  ...
  h+=`</div>`;
  h+=`<div style="padding:12px 14px;display:grid;grid-template-columns:1fr 1fr;gap:12px;overflow:auto">`;
  ...
  h+=`<div style="max-height:300px;overflow:auto;padding:8px 10px;display:flex;flex-direction:column;gap:4px">`;
