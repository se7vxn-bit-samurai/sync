...
function _collectCommandPaletteActions(){
  ...
  actions.push({id:"projects-ops",label:"Projects",hint:"Projects on this device, cloud save and sync",keywords:"projects ops files cloud sync save load account device",group:"Projects",run:()=>{if(typeof _syncOpenProjectsPanel==="function")_syncOpenProjectsPanel();}});
